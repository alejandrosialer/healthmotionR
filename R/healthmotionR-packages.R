...
#' Useful links:
#' \itemize{
#'   \item \url{https://github.com/alejandrosialer/healthmotionR}
#' }
#' }
#' @author {
#' \strong{Maintainer}: Oscar Alejandro Sialer Gallo \email{alejandro.sialer.gallo@gmail.com}
#' }
'_PACKAGE'
